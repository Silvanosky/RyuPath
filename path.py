...
def arm_and_takeoff():
    ...
    # Confirm vehicle armed before attempting to continue
...
if TRAJECTOIRE == 2:
    ...
    print("Set groundspeed to 5m/s.")
    vehicle.groundspeed = 3
    goto(2, 1, goto_position_target_global_int)

    print("Position South 0 East 200")
    goto(0, -1, goto_position_target_global_int)

    print("Position North 100 West 130")
    goto(-2, 0, goto_position_target_global_int)
...
if TRAJECTOIRE == 3:
    ...
    print("North 2m, East 0m, 0.5m altitude for %s seconds" % DURATION)
    goto_position_target_local_ned(2,0,-0.5)
    ...
    print("North 0m, East 2m, 0.5m altitude")
    goto_position_target_local_ned(2, 2, -0.5)
    time.sleep(DURATION)
    ...
    print("North 0m, East 2m, 0.5m altitude")
    goto_position_target_local_ned(0,2,-0.5)
    time.sleep(DURATION)

    print("North 0m, East 0m, 0.5m altitude")
...
if TRAJECTOIRE == 4:
    #Attention cette manoeuvre est hasardeuse
    """
